...
{/* add border-black to see container dimensions */}
        <div className="flex border h-[85vh] w-[80vw] justify-evenly">
          ...
          <div className="flex flex-col w-[40%] h-[100%] space-y-8">
            ...
            <p className="text-gray-400 font-thin orangeTransition">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, eligendi reiciendis, mollitia illo voluptas inventore necessitatibus tempora vitae enim eum incidunt ea vel aliquam repellat praesentium quaerat aliquid sint dolor.</p>
